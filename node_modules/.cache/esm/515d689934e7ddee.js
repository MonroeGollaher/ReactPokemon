let axios,jwt,jwksRsa,Cache,BadRequest,Forbidden,Unauthorized;_34e‍.x([["Auth0Provider",()=>Auth0Provider]]);_34e‍.w("axios",[["default",["axios"],function(v){axios=v}]]);_34e‍.w("express-jwt",[["default",["jwt"],function(v){jwt=v}]]);_34e‍.w("jwks-rsa",[["default",["jwksRsa"],function(v){jwksRsa=v}]]);_34e‍.w("node-cache",[["default",["Cache"],function(v){Cache=v}]]);_34e‍.w("./Errors.js",[["BadRequest",["BadRequest"],function(v){BadRequest=v}],["Forbidden",["Forbidden"],function(v){Forbidden=v}],["Unauthorized",["Unauthorized"],function(v){Unauthorized=v}]]);





let userInfoCache = new Cache({ stdTTL: 60 });
